...
autogenerated
 ...
 job: &main.GenStringJob{Fields:map[string][]string{"Customer":[]string{"ID", "Live", "Email", "Description"}, "Dispute":[]string{"ID", "Live", "Amount", "Currency", "Status", "Charge"}, "Token":[]string{"ID", "Live", "Used", "Card"}, "Transaction":[]string{"ID", "Live", "Amount", "Currency", "Type"}, "BankAccount":[]string{"ID", "Live"}, "Card":[]string{"ID", "Live", "LastDigits", "Brand", "ExpirationMonth", "ExpirationYear", "Name"}, "Charge":[]string{"ID", "Live", "Amount", "Currency", "Capture", "Authorized", "Captured"}, "Recipient":[]string{"ID", "Live", "Name", "Email", "Type"}, "Refund":[]string{"ID", "Live", "Amount", "Currency", "Charge"}, "Transfer":[]string{"ID", "Live", "Recipient", "Sent", "Paid", "Amount", "Currency"}, "Account":[]string{"ID", "Live", "Email"}, "Balance":[]string{"ID", "Live", "Available", "Total", "Currency"}, "Deletion":[]string{"ID", "Live"}}}
  on: Wed Nov 18 14:33:56 +0700 2015
  by: chakrit
*/
