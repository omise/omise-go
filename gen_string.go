...
autogenerated
 ...
 job: &main.GenStringJob{Fields:map[string][]string{"Balance":[]string{"ID", "Live", "Available", "Total", "Currency"}, "BankAccount":[]string{"ID", "Live", "Brand", "LastDigits", "Name"}, "Recipient":[]string{"ID", "Live", "Name", "Email", "Type"}, "Token":[]string{"ID", "Live", "Used", "Card"}, "Transfer":[]string{"ID", "Live", "Recipient", "Sent", "Paid", "Amount", "Currency"}, "Account":[]string{"ID", "Live", "Email"}, "Charge":[]string{"ID", "Live", "Amount", "Currency", "Capture", "Captured", "Authorized", "Paid"}, "Customer":[]string{"ID", "Live", "Email", "Description"}, "Deletion":[]string{"ID", "Live", "Deleted"}, "Dispute":[]string{"ID", "Live", "Amount", "Currency", "Status", "Charge"}, "Refund":[]string{"ID", "Live", "Amount", "Currency", "Charge"}, "Transaction":[]string{"ID", "Live", "Amount", "Currency", "Type"}, "Card":[]string{"ID", "Live", "LastDigits", "Brand", "ExpirationMonth", "ExpirationYear", "Name"}}}
