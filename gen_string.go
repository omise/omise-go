...
autogenerated
 ...
 job: &main.GenStringJob{Fields:map[string][]string{"Transfer":[]string{"ID", "Live", "Recipient", "Sent", "Paid", "Amount", "Currency"}, "Balance":[]string{"ID", "Live", "Available", "Total", "Currency"}, "BankAccount":[]string{"ID", "Live", "Brand", "Name", "LastDigits"}, "Card":[]string{"ID", "Live", "LastDigits", "Brand", "ExpirationMonth", "ExpirationYear", "Name"}, "Charge":[]string{"ID", "Live", "Amount", "Currency", "Capture", "Authorized", "Captured"}, "Recipient":[]string{"ID", "Live", "Name", "Email", "Type"}, "Token":[]string{"ID", "Live", "Used", "Card"}, "Account":[]string{"ID", "Live", "Email"}, "Customer":[]string{"ID", "Live", "Email", "Description"}, "Deletion":[]string{"ID", "Live"}, "Dispute":[]string{"ID", "Live", "Amount", "Currency", "Status", "Charge"}, "Refund":[]string{"ID", "Live", "Amount", "Currency", "Charge"}, "Transaction":[]string{"ID", "Live", "Amount", "Currency", "Type"}}}
