...
autogenerated
 ...
 job: &main.GenStringJob{Fields:map[string][]string{"Card":[]string{"ID", "Live", "LastDigits", "Brand", "ExpirationMonth", "ExpirationYear", "Name"}, "Charge":[]string{"ID", "Live", "Amount", "Currency", "Capture", "Authorized", "Reversed", "Paid"}, "Transaction":[]string{"ID", "Live", "Source", "Type", "Amount", "Currency", "Transferable"}, "Account":[]string{"ID", "Live", "Email"}, "Dispute":[]string{"ID", "Live", "Amount", "Currency", "Status", "Charge"}, "Recipient":[]string{"ID", "Live", "Name", "Email", "Type"}, "Refund":[]string{"ID", "Live", "Amount", "Currency", "Charge"}, "SearchResult":[]string{"ID", "Live"}, "Balance":[]string{"ID", "Live", "Available", "Total", "Currency"}, "Customer":[]string{"ID", "Live", "Email", "Description"}, "Document":[]string{"ID", "Live", "Filename"}, "Event":[]string{"ID", "Live", "Key", "Data"}, "Token":[]string{"ID", "Live", "Used", "Card"}, "BankAccount":[]string{"ID", "Live", "Brand", "LastDigits", "Name"}, "Transfer":[]string{"ID", "Live", "Recipient", "Sent", "Paid", "Fee", "Amount", "Currency"}, "Deletion":[]string{"ID", "Live", "Deleted"}}}
