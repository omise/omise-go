...
autogenerated
 ...
 job: &main.GenStringJob{Fields:map[string][]string{"Token":[]string{"ID", "Live", "Used", "Card"}, "Card":[]string{"ID", "Live", "LastDigits", "Brand", "ExpirationMonth", "ExpirationYear", "Name"}, "Account":[]string{"ID", "Live", "Email"}, "BankAccount":[]string{"ID", "Live", "Brand", "LastDigits", "Name"}, "Customer":[]string{"ID", "Live", "Email", "Description"}, "Deletion":[]string{"ID", "Live", "Deleted"}, "Dispute":[]string{"ID", "Live", "Amount", "Currency", "Status", "Charge"}, "Refund":[]string{"ID", "Live", "Amount", "Currency", "Charge"}, "Transfer":[]string{"ID", "Live", "Recipient", "Sent", "Paid", "Amount", "Currency"}, "Balance":[]string{"ID", "Live", "Available", "Total", "Currency"}, "Charge":[]string{"ID", "Live", "Amount", "Currency", "Capture", "Captured", "Authorized", "Paid"}, "Event":[]string{"ID", "Live", "Key", "Data"}, "Recipient":[]string{"ID", "Live", "Name", "Email", "Type"}, "Transaction":[]string{"ID", "Live", "Amount", "Currency", "Type"}}}
  on: Wed Dec 02 16:50:46 +0700 2015
  by: chakrit
*/
