...
autogenerated
 ...
 job: &main.GenStringJob{Fields:map[string][]string{"Deletion":[]string{"ID", "Live", "Deleted"}, "Dispute":[]string{"ID", "Live", "Amount", "Currency", "Status", "Charge"}, "Link":[]string{"ID", "Live"}, "Recipient":[]string{"ID", "Live", "Name", "Email", "Type"}, "Account":[]string{"ID", "Live", "Email"}, "BankAccount":[]string{"ID", "Live", "Brand", "LastDigits", "Name"}, "Transfer":[]string{"ID", "Live", "Recipient", "Sent", "Paid", "Fee", "Amount", "Currency"}, "Card":[]string{"ID", "Live", "LastDigits", "Brand", "ExpirationMonth", "ExpirationYear", "Name"}, "Refund":[]string{"ID", "Live", "Amount", "Currency", "Charge"}, "Charge":[]string{"ID", "Live", "Amount", "Currency", "Capture", "Authorized", "Reversed", "Paid"}, "Transaction":[]string{"ID", "Live", "Source", "Type", "Amount", "Currency", "Transferable"}, "Document":[]string{"ID", "Live", "Filename"}, "Event":[]string{"ID", "Live", "Key", "Data"}, "Token":[]string{"ID", "Live", "Used", "Card"}, "Balance":[]string{"ID", "Live", "Available", "Total", "Currency"}, "Customer":[]string{"ID", "Live", "Email", "Description"}}}
