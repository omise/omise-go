...
autogenerated
 ...
 job: &main.GenAPITreeJob{Names:[]string{"Account", "Balance", "Card", "Charge", "Customer", "Dispute", "Event", "Recipient", "Refund", "Token", "Transaction", "Transfer"}, Operations:map[string][]string{"Charge":[]string{"Capture", "Create", "List", "Retrieve", "Update"}, "Customer":[]string{"Create", "Destroy", "List", "Retrieve", "Update"}, "Recipient":[]string{"Create", "Destroy", "List", "Retrieve", "Update"}, "Refund":[]string{"Create", "List", "Retrieve"}, "Token":[]string{"Create", "Retrieve"}, "Event":[]string{"List", "Retrieve"}, "Balance":[]string{"Retrieve"}, "Transfer":[]string{"Create", "Destroy", "List", "Retrieve", "Update"}, "Card":[]string{"Destroy", "List", "Retrieve", "Update"}, "Dispute":[]string{"List", "Retrieve", "Update"}, "Transaction":[]string{"List", "Retrieve"}, "Account":[]string{"Retrieve"}}}
  on: Wed Dec 02 17:41:14 +0700 2015
  by: chakrit
*/
