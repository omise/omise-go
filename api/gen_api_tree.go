...
autogenerated
 ...
 job: &main.GenAPITreeJob{Names:[]string{"Account", "Balance", "Card", "Charge", "Customer", "Dispute", "Event", "Recipient", "Refund", "Token", "Transaction", "Transfer"}, Operations:map[string][]string{"Token":[]string{"Create", "Retrieve"}, "Transfer":[]string{"Create", "Destroy", "List", "Retrieve", "Update"}, "Card":[]string{"Destroy", "List", "Retrieve", "Update"}, "Event":[]string{"List", "Retrieve"}, "Charge":[]string{"Capture", "Create", "List", "Retrieve", "Reverse", "Update"}, "Customer":[]string{"Create", "Destroy", "List", "Retrieve", "Update"}, "Recipient":[]string{"Create", "Destroy", "List", "Retrieve", "Update"}, "Refund":[]string{"Create", "List", "Retrieve"}, "Transaction":[]string{"List", "Retrieve"}, "Balance":[]string{"Retrieve"}, "Dispute":[]string{"List", "Retrieve", "Update"}, "Account":[]string{"Retrieve"}}}
